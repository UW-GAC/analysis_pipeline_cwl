...
doc: |-
  ...
  ***Please note that any cloud infrastructure costs resulting from app and pipeline executions, including the use of public apps, are the sole responsibility of you as a user. To avoid excessive costs, please read the app description carefully and set the app parameters and execution settings accordingly.***
  ...
  ### Common Use Cases 
  **GENESIS LocusZoom** is used to make annotated Manhattan plots on specific regions from association files generated by GENESIS workflows. **GENESIS LocusZoom Plots** can work with outputs from **GENESIS Single Variant Association Testing**, **GENESIS Aggregate Association Testing** and **GENESIS Sliding Window Association testing** workflows. **Association results file** originating from **GENESIS Single Variant Association Testing** is required even when results from Sliding Window or Aggregate tests are visualized. Sliding Window or Aggregate results are optional inputs provided via the **Track file** input. One PDF file is generated for each locus defined in the **Loci file**.
  ...
  For visualization, LD calculation and additional information, **LocusZoom** uses several databases. Due to the size of these databases, they cannot be included in the Docker image, but have to be provided every time this App is run. There are two ways to provide these database to the **GENESIS LocusZoom** App:
...
id: |-
  https://api.sb.biodatacatalyst.nhlbi.nih.gov/v2/apps/admin/sbg-public-data/genesis-locuszoom/3/raw/
sbg:appVersion:
- v1.1
sbg:categories:
- Plotting and Rendering
sbg:content_hash: ab7f365801eeba22b6a48cde970345e72fa60ea821257a4f9cba91e60d78ae1a5
sbg:contributors:
- admin
sbg:createdBy: admin
sbg:createdOn: 1608749020
sbg:id: admin/sbg-public-data/genesis-locuszoom/3
sbg:image_url:
